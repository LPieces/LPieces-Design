...
var SubMenu = function (_a) {
    ...
    var classes = classNames('lpd-menu-item lpd-submenu-item', className, {
    ...
    var renderChildren = function () {
        var subMenuClasses = classNames('lpd-menu-submenu', {
        ...
        return (React.createElement(Transition, { in: menuOpen, timeout: 300, animation: "lpd-zoom-in-right" },
    ...
    return (React.createElement("li", __assign({ key: index, className: classes }, hoverEvents),
        React.createElement("div", __assign({ className: "lpd-submenu-title" }, clickEvents),
            title,
